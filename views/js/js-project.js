...
function updateProjectInfo(data) {
    ...
    document.getElementById("highlight-img").src = "http://localhost/cf/pic/"+data.projects_id+"_1.png";
    document.getElementById("secondary-img-1").src = "http://localhost/cf/pic/"+data.projects_id+"_2.png";
    document.getElementById("secondary-img-2").src = "http://localhost/cf/pic/"+data.projects_id+"_3.png";
    document.getElementById("secondary-img-3").src = "http://localhost/cf/pic/"+data.projects_id+"_4.png";
    ...
    document.getElementById("designer-avatar").src = base_url+"avatar/"+data.users_id + ".png";
